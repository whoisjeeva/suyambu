class ElementFinder {
        ...
        (new Hammer(document)).on("press", e => {
            if (!this._isHidden(e.target)) {
                ...
                if (sameElement !== null) {
                    ...
                    this.elements.push({ selector: "body " + selector, elIndex: currentElIndex, attrs: this._attrToArray(e.target, e.target.attributes), isFindSimilar: false })
    ...
    findNearestElement(tagName) {
        ...
        if (foundEl !== null) {
            ...
            this.elements = []
            this.elements.push({selector: "body " + selector, elIndex: currentElIndex, attrs: this._attrToArray(foundEl, foundEl.attributes), isFindSimilar: false})
            Native.showAlertWithElements(JSON.stringify(this.elements))
